...
namespace AplikacijaDijeljenihRadnihMjesta.Migrations
{
    ...
    [Migration("20210714091619_DodavanjeTabliceSobaIPromjenaTabliceLokacija")]
    partial class DodavanjeTabliceSobaIPromjenaTabliceLokacija
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AplikacijaDijeljenihRadnihMjesta.Models.Sobe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LokacijaSobe", b =>
                {
                    b.Property<int>("LokacijaId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("LokacijaId", "SobeId");

                    b.HasIndex("SobeId");

                    b.ToTable("LokacijaSobe");
                });
            ...
            modelBuilder.Entity("LokacijaSobe", b =>
                {
                    ...
                    b.HasOne("AplikacijaDijeljenihRadnihMjesta.Models.Sobe", null)
                        .WithMany()
